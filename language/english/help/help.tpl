<div id="help-template" class="outer">
    <{include file=$smarty.const._MI_MTOOLS_HELP_HEADER}>

    <h4 class="odd">DESCRIPTION</h4> <br>

    <p class="even">This module is a collection of common classes, traits, and functions for XOOPS Modules<br> <br>
    </p>
    ...
    <p class="even">
        Tutorial has been started, but we might need your help! Please check out the status of the tutorial <a href="https://app.gitbook.com/@xoops/s/mtools-tutorial/" target="_blank">here </a>.
        <br><br>To contribute to this Tutorial, <a href="https://github.com/XoopsDocs/mtools-tutorial/" target="_blank">please fork it on GitHub</a>.
    ...
    <p class="even">
        This module is Open Source and we would love your help in making it better! You can fork this module on <a href="https://github.com/XoopsModules25x/mtools" target="_blank">GitHub</a><br><br>
