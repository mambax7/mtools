...
use XoopsModules\Mtools\Constants;
...
class Utility extends Common\SysUtility
{
    ...
    public static function html5($content = '', $ui = false, $bootstrap = true, $bootstrap_version = 3, $use_jquery = true, $container = 'container', $title = 'XOOPS', $head_code = ''): string
    {
        ...
        $bootstrap_link = $bootstrap ? "<link rel='stylesheet' type='text/css' media='all' href='" . XOOPS_URL . "/modules/mtools/bootstrap{$bootstrap_version}/css/bootstrap.css' />" : '';
        ...
        if ($in_admin) {
            ...
            if ($xoTheme) {
                if ('bootstrap3' === $tt_bootstrap_color) {
                    // $xoTheme->addStylesheet(XOOPS_URL . '/modules/mtools/bootstrap3/css/bootstrap.css');
                    // $xoTheme->addStylesheet(XOOPS_URL . '/modules/mtools/css/xoops_adm3.css');
                    ...
                    if ('bootstrap4' === $c[0]) {
                        $xoTheme->addStylesheet(XOOPS_URL . '/modules/mtools/bootstrap4/css/bootstrap.css');
                        $xoTheme->addStylesheet(XOOPS_URL . '/modules/mtools/css/xoops_adm4.css');
                        $xoTheme->addStylesheet(XOOPS_URL . '/modules/mtools/' . $tt_bootstrap_color . '/bootstrap.min.css');
                ...
                $xoTheme->addStylesheet(XOOPS_URL . '/modules/mtools/css/fix-bootstrap.css');
                $xoTheme->addStylesheet(XOOPS_URL . '/modules/mtools/css/font-awesome/css/font-awesome.css');
            }
        } elseif ('return' === $mode) {
            if ('bootstrap4' === $tt_theme_kind) {
                $main = "
                <link rel='stylesheet' type='text/css' href='" . XOOPS_URL . "/modules/mtools/bootstrap4/css/bootstrap.css'>";
            } else {
                $main = "
                <link rel='stylesheet' type='text/css' href='" . XOOPS_URL . "/modules/mtools/bootstrap3/css/bootstrap.css'>";
            }
            $main .= "<link rel='stylesheet' type='text/css' href='" . XOOPS_URL . "/modules/mtools/css/font-awesome/css/font-awesome.css'>";
    ...
    public static function push_url($enable = 1, $css = 'width:auto;margin:10px;float:right;')
    {
        ...
        $main = "
        <link rel='stylesheet' href='" . XOOPS_URL . "/modules/mtools/social-likes/social-likes_birman.css'>
        $jquery
        <script src='" . XOOPS_URL . "/modules/mtools/social-likes/social-likes.min.js'></script>
...
if (empty($default_array) && '1' == $default) {
    ...
    public static function get_jquery($ui = false, $mode = '', $theme = 'base'): ?string
    {
        ...
        if (!isset($xoTheme) or 'return' === $mode) {
            ...
            if ($ui) {
                $jqueryui_path = "
                <link href='" . XOOPS_URL . "/modules/mtools/jquery/themes/{$theme}/jquery.ui.all.css' rel='stylesheet' type='text/css'>
                <script src='" . XOOPS_URL . "/modules/mtools/jquery/ui/jquery-ui.js'></script>
                <script src='" . XOOPS_URL . "/modules/mtools/jquery/jquery.ui.touch-punch.min.js'></script>";
            }
            $ver = self::get_version('xoops');
            if ($ver >= 20509) {
                $jquery_path = "
                ...
                document.write(\"<script type='text/javascript' src='" . XOOPS_URL . "/modules/mtools/jquery/jquery-3.2.1.js'><\/script>\");
                // document.write(\"<script type='text/javascript' src='" . XOOPS_URL . "/modules/mtools/jquery/jquery-migrate-3.0.0.min.js'><\/script>\");
                // document.write(\"<script type='text/javascript' src='" . XOOPS_URL . "/modules/mtools/jquery/jquery.jgrowl.js'><\/script>\");
                }
                </script>
                $jqueryui_path
                ";
                ...
                if(typeof jQuery == 'undefined') {
                document.write(\"<script type='text/javascript' src='" . XOOPS_URL . "/modules/mtools/jquery/jquery-3.2.1.js'><\/script>\");
                // document.write(\"<script type='text/javascript' src='" . XOOPS_URL . "/modules/mtools/jquery/jquery-migrate-1.4.1.min.js'><\/script>\");
                // document.write(\"<script type='text/javascript' src='" . XOOPS_URL . "/modules/mtools/jquery/jquery.jgrowl.js'><\/script>\");
                }
                </script>
                $jqueryui_path
